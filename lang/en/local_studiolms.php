...
$string['aikeys_info'] = 'StudioLMS generates content through Moodle core_ai or, when installed, the PlayerGames hub (local_playergames). There is no API key to configure here — set up an AI provider under Site administration → AI, or in the PlayerGames settings.';
