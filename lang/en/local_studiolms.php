...
$string['briefing_bloom'] = 'Predominant cognitive level (Bloom\'s)';
...
$string['btn_generate_outline'] = 'Generate outline';
$string['error_theme_required'] = 'Please enter the theme or content focus.';
$string['fillwithai'] = 'Fill with AI (Studio)';
$string['gamification_profile'] = 'Gamification profile';
$string['generate_heading'] = 'Fill course with AI';
$string['generating'] = 'Generating outline...';
