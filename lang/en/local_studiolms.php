...
$string['aikeys_info'] = 'StudioLMS generates content through the PlayerGames hub (local_playergames) when installed, the StudioLMS editor (tiny_studiolms) keys when present, or Moodle core_ai. There is no API key to configure here — set up an AI provider under Site administration → AI, or in the PlayerGames settings.';
...
$string['noai_teacher'] = 'Ask your site administrator to enable an AI provider (Site administration → AI → AI providers), or to install the PlayerGames hub (local_playergames) so you can add a personal key.';
$string['noaiprovider'] = 'No AI provider is available. Configure a provider in Moodle AI (Site administration → AI → AI providers), install the PlayerGames hub (local_playergames) and set an API key, or configure keys in the StudioLMS editor (tiny_studiolms).';
