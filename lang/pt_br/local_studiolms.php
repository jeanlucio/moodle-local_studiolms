...
$string['aikeys_info'] = 'O StudioLMS gera conteúdo via Central de IA (local_aihub) quando instalada, pelas chaves do editor StudioLMS (tiny_studiolms) quando presente, ou pelo core_ai do Moodle. Não há chave de API para configurar aqui — configure um provedor de IA em Administração do site → IA, ou nas configurações da Central de IA.';
$string['aiusage'] = 'Geração de conteúdo de curso';
...
$string['noai_teacher'] = 'Peça ao administrador do site para habilitar um provedor de IA (Administração do site → IA → Provedores de IA), ou para instalar a Central de IA (local_aihub) para você adicionar uma chave pessoal.';
$string['noaiprovider'] = 'Nenhum provedor de IA disponível. Configure um provedor na IA do Moodle (Administração do site → IA → Provedores de IA), instale a Central de IA (local_aihub) e cadastre uma chave de API, ou configure chaves no editor StudioLMS (tiny_studiolms).';
