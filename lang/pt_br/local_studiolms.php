...
$string['briefing_bloom'] = 'Nível cognitivo predominante (Bloom)';
...
$string['mode_gamified_disabled'] = 'Instale o PlayerHUD para ativar este modo';
$string['mode_standard'] = 'Padrão';
$string['objectives_heading'] = 'Objetivos de aprendizagem';
$string['outline_review_heading'] = 'Revisão do outline';
