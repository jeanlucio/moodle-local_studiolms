...
$string['aikeys_configure'] = 'Configurar';
$string['aikeys_info'] = 'As chaves de IA são gerenciadas pelo editor StudioLMS (tiny_studiolms). O StudioLMS reutiliza essa configuração, então não há nada a configurar aqui.';
