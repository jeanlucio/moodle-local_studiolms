...
$string['aikeys_info'] = 'O StudioLMS gera conteúdo via core_ai do Moodle ou, quando instalado, o hub PlayerGames (local_playergames). Não há chave de API para configurar aqui — configure um provedor de IA em Administração do site → IA, ou nas configurações do PlayerGames.';
...
$string['noaiprovider'] = 'Nenhum provedor de IA disponível. Configure um provedor na IA do Moodle (Administração do site → IA → Provedores de IA), ou instale o hub PlayerGames (local_playergames) e cadastre uma chave de API.';
